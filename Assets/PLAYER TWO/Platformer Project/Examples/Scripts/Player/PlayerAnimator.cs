...
public class PlayerAnimator :MonoBehaviour
{
    ...
    protected virtual void InitializeAnimatorTrigger()
    {
        m_player.states.events.onChange.AddListener(() => animator.SetTrigger(m_onStateChangedHash));
    }

    protected virtual void InitializeForceTransitions()
    {
    ...
    {
        InitializePlayer();
        InitializeForceTransitions();
        InitializeParametersHash();
        InitializeAnimatorTrigger();
    ...
    protected virtual void HandleAnimatorParameters()
    {
        ...
        animator.SetBool(m_isGroundedHash, m_player.holding);
    }
