...
public class PlayerCamera :MonoBehaviour
{
    ...
    protected virtual void MoveTarget()
    {
        ...
        m_target.rotation = Quaternion.Euler(m_cameraTargetPitch, m_cameraTargetYaw, 0);
    ...
    protected virtual void HandleVelocityOrbit()
    {
        ...
        {
            var localCelocity = m_target.InverseTransformVector(player.velocity);
            m_cameraTargetYaw += localCelocity.x * orbitVelocityMultiplier * Time.deltaTime;
        }
    }
